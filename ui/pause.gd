...
func _unhandled_input(event: InputEvent) -> void:
	...
	if event.is_action_pressed("fullscreen"):
		...
		$vbox/settings/fullscreen.button_pressed = !$vbox/settings/fullscreen.button_pressed
...
func _on_music_slider_drag_ended(value_changed: bool) -> void:
	AudioServer.set_bus_volume_db(_music_bus, linear_to_db($vbox/settings/music_slider.value))


func _on_effects_slider_drag_ended(value_changed: bool) -> void:
	AudioServer.set_bus_volume_db(_effects_bus, linear_to_db($vbox/settings/effects_slider.value))
